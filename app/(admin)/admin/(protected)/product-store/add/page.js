...
export default function ProductStoreCreate() {
  ...
  const handleSubmit = async (e) => {
    e.preventDefault();
    try {
      const res = await adminAxios.post("/productstore", form);
  ...
  return (
    <div>
      ...
      <a
        ...
        className="bg-blue-600 px-1 py-2 inline-block mb-2 rounded"
      >
        ← Quay lại danh sách
      </a>
      ...
      <form
        ...
        className="space-y-4 p-4 border rounded text-black"
      >
        <select
